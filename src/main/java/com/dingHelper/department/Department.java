...
public class Department {
	...
	public String toString() {
		return "Department [id=" + id + ", name=" + name + ", parentid=" + parentid + ", order=" + order
				+ ", createDeptGroup=" + createDeptGroup + ", autoAddUser=" + autoAddUser + ", deptHiding=" + deptHiding
				+ ", deptPerimits=" + deptPerimits + ", userPerimits=" + userPerimits + ", outerDept=" + outerDept
				+ ", outerPermitDepts=" + outerPermitDepts + ", outerPermitUsers=" + outerPermitUsers
				+ ", orgDeptOwner=" + orgDeptOwner + ", deptManagerUseridList=" + deptManagerUseridList + "]";
	}
